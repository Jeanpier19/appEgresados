        ...
        <section class="card">
            <header class="card-header">
                ...
                <div class="pull-right">
                    {{--@can('usuarios-crear')--}}
                        <a href="{{route('especialidad.create')}}" class="btn btn-inline btn-success btn-rounded btn-sm"><i
            ...
            <div class="card-block">
                ...
                <table id="table" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>Nombre de Escuelas</th>
                        <th>Nombre de Especialidades</th>
                        <th>Acciones</th>
                    </tr>
                    </thead>
                    <tbody></tbody>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            let tabla = $('#table').DataTable(
                {
                    ...
                    "ajax": {
                        "url": "{{ route('especialidad.get_especialidad_all') }}",
                        "dataType": "json",
                        "type": "POST",
                        "data": {
                            _token: "{{csrf_token()}}"
            ...
            $('#table tbody').on('click', '.delete-confirm', function () {
                let idespecialidad = $(this).attr('data-id');
                let url = '{!! url('gape/manteiner/especialidad/destroy') !!}/' + idespecialidad;
                swal({
                        title: '¿Estás seguro?',
