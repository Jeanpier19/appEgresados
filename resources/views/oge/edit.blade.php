...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($oge, ['id'=>'form-oge','method' => 'PATCH','route' => ['oge.update']]) !!}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Nombre del Director OGE:</strong>
                            {!! Form::text('valor', null, array('placeholder' => 'Nombre del Director OGE','class' => 'form-control')) !!}
                        </div>
                    </div>
                </div>
            </div>
