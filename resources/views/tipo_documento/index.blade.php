            ...
            <header class="card-header">
                <div class="pull-left">
                    <ol class="breadcrumb breadcrumb-simple">
                        ...
                        <li class="active">Lista de Tipo de Documentos</li>
                    </ol>
                </div>
                <div class="pull-right">
                    {{--@can('usuarios-crear')--}}
                        <a href="{{route('tipo.create')}}" class="btn btn-inline btn-success btn-rounded btn-sm"><i
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#table tbody').on('click', '.delete-confirm', function () {
                let idtipo = $(this).attr('data-id');
                let url = '{!! url('gape/manteiner/tipo/destroy') !!}/' + idtipo;
                swal({
                        title: '¿Estás seguro?',
                                ...
                                success: function (response) {
                                    if (response.success) {
                                        ...
                                        $.notify({
                                            ...
                                            message: 'Hubo un error al eliminar el Tipo de Documento.'
                                        },{
                                            placement: {
                                                from: "top",
                                            },
