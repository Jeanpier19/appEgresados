...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::open(array('route' => 'semestre.store','method'=>'POST','id'=>'form-semestre')) !!}
            <div class="card-block">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div class="form-group">
                            <strong>Descripción del Semestre:</strong>
                            {!! Form::text('descripcion', null, array('placeholder' => 'Descripción del Semestre','class' => 'form-control')) !!}
                        </div>
                    </div>
