        ...
        <section class="card">
            <header class="card-header">
                ...
                <div class="pull-right">
                    @can('menciones-crear')
                        <a href="{{route('menciones.create')}}" class="btn btn-inline btn-success btn-rounded btn-sm"><i
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            let tabla = $('#table').DataTable(
                {
                    ...
                    "ajax": {
                        "url": "{{ route('menciones.get_mencion_all') }}",
                        "dataType": "json",
                        "type": "POST",
                        "data": {
                            _token: "{{csrf_token()}}"
            ...
            $('#table tbody').on('click', '.delete-confirm', function () {
                ...
                let url = '{!! url('gape/manteiner/menciones') !!}/' + id;
                swal({
                        title: '¿Estás seguro?',
                                ...
                                success: function (response) {
                                    if (response.success) {
                                        ...
                                        $.notify({
                                            ...
                                            message: 'Hubo un error al eliminar la mención.'
                                        },{
                                            placement: {
                                                from: "top",
                                            },
