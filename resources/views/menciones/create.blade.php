...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::open(array('id'=>'form-menciones','route' => 'menciones.store','method'=>'POST')) !!}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('maestria_id', $maestrias->pluck('nombre','id'),[], array('class' => 'bootstrap-select','title'=>'Elige uno de los siguientes...','data-live-search' => 'true', 'required','data-container'=>'body', 'data-width'=>'100%')) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
