                ...
                <div class="row">
                    <form id="reporte" method="GET" action="{{ route('export') }}" target="_blank">
                        ...
                        <div class="col-xs-12 col-md-3">
                            ...
                            {{ Form::select('facultad_id', $facultades->pluck('nombre', 'id'), null, ['id' => 'facultad_id', 'class' => 'selectpicker', 'title' => 'Seleccione...', 'data-container' => 'body', 'data-width' => '100%', 'data-live-search' => 'true', 'data-max-options' => '1', 'multiple']) }}
                        </div>
                        <div class="col-xs-12 col-md-3">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            let tabla = $('#table').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('egresadosn.getEgresados') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d) {
                        d._token = "{{ csrf_token() }}";
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(response, function(index, value) {
                                escuelas += '<option value="' + value['id'] + '">' +
                                    value['nombre'] + '</option>';
                            });
