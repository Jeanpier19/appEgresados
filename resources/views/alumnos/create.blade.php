...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::open(array('id'=>'alumnos','route' => 'alumnos.store','method'=>'POST')) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
                            ...
                            {{ Form::select('sexo',['Masculino'=>'Masculino','Femenino'=>'Femenino'], null, array('id' => 'sexo','class' => 'bootstrap-select','title'=>'Seleccione...','required')) }}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
