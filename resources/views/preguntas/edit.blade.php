                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class='checkbox-toggle'>
                            <input name="activo" type='checkbox' id='check-toggle-activo'
                                   @if($pregunta->activo == 1) checked @endif />
                            <label for='check-toggle-activo'></label></div>
                    </div>
                    ...
                    <div id="multiple"
                         style="@if($pregunta->tipo === "Respuesta Breve" || $pregunta->tipo === "Párrafo")display: none;@endif">
                        <div class="col-xs-12">
                            <div class="form-group">
                        ...
                        <div id="opciones" class="col-xs-12 col-sm-12 col-md-12">
                            @if(isset($pregunta->opciones) && !is_null($pregunta->opciones))
                                @foreach(json_decode($pregunta->opciones) as $opcion)
                                    <div class="form-group input-group">
                                        <div class="input-group-addon"><i class="fa fa-check-circle"></i></div>
                                        <input name="opciones[]" type="text" class="form-control"
                                               placeholder="Agregar una opción" value="{{$opcion}}">
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-default-outline eliminar_opcion"><i
