...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::open(['route' => 'documento.store', 'method' => 'POST', 'file' => true, 'enctype' => 'multipart/form-data', 'id' => 'form-documento','onsubmit'=>'return submitContinue();']) !!}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('tipo', $tipo, ['class' => 'form-control'], ['class' => 'custom-select', 'id' => 'tipo_documento']) !!}
                        </div>
                        <div class="form-group" id="respuestaOGE">
                            <strong>Documento de Respuesta:</strong><br>
                            {!! Form::select('respuesta1', $respuestaOGE, ['class' => 'form-control'], ['class' => 'custom-select', 'placeholder' => 'Seleccionar']) !!}
                        </div>
                        <div class="form-group" id="respuestaSGE">
                            <strong>Documento de Respuesta:</strong><br>
                            {!! Form::select('respuesta2', $respuestaSGE, ['class' => 'form-control'], ['class' => 'custom-select', 'placeholder' => 'Seleccionar']) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        ...
                        <div id="archivo" class="dropzone">
                            ...
                            <div class="fallback">
                                <input type="file" name="file2" id="documento-file" class="form-control" multiple="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            $('#archivo').dropzone({
                ...
                init: function() {
                    ...
                    submitBtn.addEventListener("click", function(e) {
                        ...
                        if ($('#form-documento')[0].checkValidity()) {
