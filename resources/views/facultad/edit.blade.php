...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($facultad, ['id'=>'facultad','method' => 'PATCH','route' => ['facultad.update', $facultad->id]]) !!}
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::text('nombre', null, array('id'=>'nombre','placeholder' => 'Nombre de la Facultad','class' => 'form-control')) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-2 col-md-2">
                        <div class="form-group">
                        <strong>Logo actual:</strong>
                        <img src="@if($facultad->logo){{ asset($facultad->logo) }} @else {{asset('img/default.png')}} @endif" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
