...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($oferta_capacitacion,['route' => 'ofertas_capacitaciones.update', 'method' => 'POST', 'file' => true, 'enctype' => 'multipart/form-data','onsubmit'=>'return submitContinue();']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10 col-sm-10 col-md-10">
                                    <div class="form-group">
                                        {!! Form::hidden('idoferta', $oferta_capacitacion->id) !!}
                                        {!! Form::hidden('idcurso', $oferta_capacitacion->idcurso) !!}
                                ...
                                <div class="col-xs-10 col-sm-10 col-md-10">
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('descripcion_oferta', null, ['placeholder' => 'Describa el curso a publicar...', 'class' => 'form-control', 'id' => 'descripcion_oferta','onkeyup'=>"MaxMinCadenas('send-oferta',255,1,this,true)"]) !!}
                                    </div>
                                    <div class="form-group">
