...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($comunicado, ['id'=>'comunicados','method' => 'PATCH','route' => ['comunicados.update', $comunicado->id]]) !!}
            <div class="card-block">
                ...
                @endif
                <div class="row">
                    <input id="imagen" type="hidden" name="imagen" value="{{$comunicado->imagen}}">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3">
                        <div class="form-group">
                            <strong>Banner actual:</strong>
                            <img src="@if($comunicado->imagen){{ asset($comunicado->imagen) }} @else {{asset('img/default.png')}} @endif" alt="" class="img-fluid img-thumbnail">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-9 col-md-9">
