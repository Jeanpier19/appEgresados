...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($oferta_laboral, ['id'=>'ofertas_laborales','method' => 'PATCH','route' => ['ofertas_laborales.update', $oferta_laboral->id]]) !!}
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2">
                        <div class="form-group">
                            ...
                            @if($oferta_laboral->documento)
                                <a href="{{asset($oferta_laboral->documento)}}" target="_blank" class="btn btn-secondary btn-sm"> <i class="fa fa-file-pdf-o"></i> Ver documento</a>
                            @else
