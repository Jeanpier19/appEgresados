    ...
    <div class="side-menu-avatar">
        <div class="avatar-preview avatar-preview-100">
            @switch (Auth::user()->getRoleNames()[0])
                ...
                @case('Egresado')
                    <img src="@if($perfil && $perfil->avatar){{asset($perfil->avatar)}}@else{{asset('startui/img/avatar-1-256.png')}}@endif"
                     alt="">
                @break
            @endswitch
        </div>
        ...
        @switch (Auth::user()->getRoleNames()[0])
            @case('Administrador')
                ...
                <li class="blue-dark with-sub"><span>
                        ...
                        <span class="lbl">Encuestas</span></span>
                    <ul>
                ...
                <li class="blue-dark with-sub"><span>
                        <i
                            class="fa fa-chalkboard-teacher {{ request()->is('ofertas_capacitaciones*') ? 'active' : '' }}"></i>
                        <span class="lbl">Ofertas Capacitación</span></span>
                    <ul>
                        <li><a href="{{ route('ofertas_capacitaciones.index') }}"><span class="lbl">Gestionar</span></a>
                        </li>
                        <li><a href="{{ route('ofertas_capacitaciones.postulacion') }}"><span
                                    class="lbl">Postulaciones</span></a>
                        </li>
                    </ul>
                </li>
                <li class="blue-dark">
                ...
                <li class="blue-dark with-sub">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('reportes.index_ofertas') }}"><span class="lbl">Ofertas
                                    Capacitación</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="blue-dark">
                    <a href="{{ route('api') }}">
                        <i class="fa fa-tape {{ request()->is('mensajes') ? 'active' : '' }}"></i>
                        <span class="lbl">Consumo API</span>
                    </a>
                </li>
            @break
            ...
            @case('Egresado')
                ...
                <li class="blue-dark with-sub">
                    ...
                    <ul>
                        <li><a href="{{ route('necesidad-capacitaciones.index') }}"><span class="lbl">Sobre
                                    Capacitaciones</span></a></li>
                    </ul>
                </li>
                <li class="blue-dark">
                ...
                <li class="blue-dark">
                    <a href="{{ route('ofertas_capacitaciones.registro') }}">
                        <i
                            class="glyphicon glyphicon-book {{ request()->is('ofertas_capacitaciones') ? 'active' : '' }}"></i>
