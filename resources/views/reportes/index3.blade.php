            ...
            <header class="card-header">
                <div class="pull-left">
                    <ol class="breadcrumb breadcrumb-simple">
                        ...
                        <li class="active">Reportes de Egresados</li>
                    </ol>
                </div>
            ...
            <div class="card-block">
                <div class="form-group">
                    <div class="col-md-3">
                        ...
                        {!! Form::select('anio', $anios, null, ['class' => 'select2', 'placeholder' => 'Seleccionar', 'id' => 'anio']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-3">
                        ...
                        {!! Form::select('facultades', $facultades, null, ['class' => 'select2', 'placeholder' => 'Seleccionar', 'id' => 'facultad']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="col-md-3">
                        ...
                        {!! Form::select('doctorado', $doctorado, null, ['class' => 'select2', 'placeholder' => 'Seleccionar', 'id' => 'doctorado']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                        <strong>Maestrias:</strong>
                        {!! Form::select('maestria', $maestria, null, ['class' => 'select2', 'placeholder' => 'Seleccionar', 'id' => 'maestria']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                        <strong>Menciones:</strong>
                        {!! Form::select('mencion', $mencion, null, ['class' => 'select2', 'placeholder' => 'Seleccionar', 'id' => 'mencion']) !!}
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-3">
                        <br>
                        <button type="button" id='filtrar' class="btn btn-inline btn-success btn-sm">
                            Filtrar
                        </button>
                    </div>
                </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('#doctorado').change(function() {
            $('#doctorado option:selected').each(function() {
