...
@section('content')
    <div class="container-fluid">
        <section class="card">
            ...
            {!! Form::model($escuela, ['id'=>'escuela','method' => 'PATCH','route' => ['escuela.update', $escuela->id]]) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {!! Form::select('facultad_id', $facultades->pluck('nombre','id'),$escuela->facultad_id, array('class' => 'bootstrap-select','title'=>'Elige uno de los siguientes...','data-live-search' => 'true', 'required')) !!}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2">
                        <div class="form-group">
                            ...
                            <img
                                src="@if($escuela->logo){{ asset($escuela->logo) }} @else {{asset('img/default.png')}} @endif"
