                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            <div class="form-group  m-2 mx-auto d-block">
                                <img id="imagenMostrar" style="max-height: 250px;">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="tempo_id" name="tempo_id">
                                @foreach ($temporalidades as $temporal)
                                    <option value="{{ $temporal->id }}">{{ $temporal->tempo }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        ...
        // Llamar a la función para deseleccionar opciones
        deselectOptions();
    </script>
    <script>
        $(document).ready(function() {
